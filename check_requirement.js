...
document.getElementById('caption').innerHTML = "<b>"+"General Check"+"</b>";
...
var cleaning = query[7];//"!" means not required
...
function upload() {
  var info_task = firebase.database().ref('job_sheets/'+propertyCode+'/'+ 'General_Check').set({
    electricity: autofill(document.getElementById("electricity").value),
    vent: autofill(document.getElementById("vent").value),
  ...
  info_task.then(function() {
        if (img_reference.length > 0){
            for(i = 0; i<img_reference.length;i++) {
                var storageRef = firebase.storage().ref(propertyCode + "/" + "General_Check" + "/" + "image_" + i);
...
function nextRoom() {
    if (cleaning == "C") {
        if (washing == "W") {
            if (ironing == "I") {
                window.location.href = 'bedroom_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Bedroom'+"&"+'1'+"&"+"W"+"&"+"I";
            } else if (ironing == "!") {
                window.location.href = 'bedroom_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Bedroom'+"&"+'1'+"&"+"W"+"&"+"!";
            }
        } else if (washing == "!") {
            if (ironing == "I") {
                window.location.href = 'bedroom_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Bedroom'+"&"+'1'+"&"+"!"+"&"+"I";
            } else if (ironing == "!") {
                window.location.href = 'bedroom_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Bedroom'+"&"+'1'+"&"+"!"+"&"+"!";
            }
        }
        ...
        if (washing == "W"){
            if (ironing == "I") {
                window.location.href = 'washing_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Washing'+"&"+'0'+"&"+"W"+"&"+"I";
            } else if (ironing == "!") {
                window.location.href = 'washing_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Washing'+"&"+'0'+"&"+"W"+"&"+"!";
            }
        } else if (washing == "!") {
            if (ironing == "I"){
                window.location.href = 'ironing_requirement.html'+'?'+propertyCode+"&"+numBed+"&"+numBath+"&"+'Ironing'+"&"+'0'+"&"+"!"+"&"+"I";
            } else if (ironing == "!") {
                alert("ERROR: Service not chosen! Please go back to last page!");
            }
        } 
    } else {
        alert("ERROR: Service not chosen!Please go back to last page!");
